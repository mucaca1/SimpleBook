...
export function CalendarWeekView({
    ...
    const handleEventClick = useCallback((event: SchedulerEvent) => {
        // We need an anchor element - find the event block in the DOM
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            ...
            <Box ref={gridRef} sx={{ flex: 1, overflow: 'auto' }}>
                <Box sx={{ display: 'flex', position: 'relative', height: 24 * HOUR_HEIGHT }}>
                    ...
                    {days.map((day) => {
                        ...
                        // Compute draft overlay position (does not affect existing event layout)
                        ...
                        if (showDraft) {
                            ...
                            // Check if draft overlaps any existing event
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* Existing events (layout unchanged) */}
                                ...
                                {/* Draft event overlay — overlaps alongside existing events */}
                                {showDraft && (
